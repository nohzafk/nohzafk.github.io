...
title: Cheap and Capable `gpt4o-mini` Boosts Input Quality
tags: [llm]
---
API price for `gpt4o-mini` is very cheap yet the model is very capable, it is basically a nearly-free boost for the input quality for larger [[LLM]] models.
